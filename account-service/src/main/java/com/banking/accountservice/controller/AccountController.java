...
public class AccountController {
    ...
    public ResponseEntity<String> blockAccount(@PathVariable String accountNumber){
        ...
        return ResponseEntity.ok("Account bloked Successfully");
    }


    // Saga

    // step 1: called by Transaction Service when transfer is initiated
    ...
    // called by transaction service in TWO SCENRIO:
